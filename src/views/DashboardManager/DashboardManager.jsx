    ...
    const drawer = (
        <div>
            ...
            <List>
                ...
                <a href="/#/AddCourseOnline" style={{ textDecoration: 'none' }}>
                    <ListItem className="nav-link-dashboard" >
                        <ListItemIcon>
                ...
                <a href="/#/AddCourseClass" style={{ textDecoration: 'none' }}>
                <ListItem className="nav-link-dashboard" >
                    <ListItemIcon>
                ...
                <ListItem className="nav-link-dashboard" >
                    ...
                    <a href="/#/MyHistory" className="nav-list" >ประวัติการเรียน</a>
                </ListItem>
                </a>
                ...
                <a href="/#/AddTeacher" style={{ textDecoration: 'none' }}>
                <ListItem className="nav-link-dashboard" >
                    <ListItemIcon>
                ...
                <a href="/#/Dialogue/Manager" style={{ textDecoration: 'none' }}>
                <ListItem className="nav-link-dashboard" >
                ...
                <a href="/#/MyTeam" style={{ textDecoration: 'none' }}>
                <ListItem className="nav-link-dashboard" >
                                        ...
                                        <CCol xs="12" md="12" xl="12">
                                            ...
                                            <div className={classes.root}>
                                                <GridList cellHeight={300} className={classes.gridList} >
                                                    ...
                                                    {
                                                        CourseData.filter(id => id.courseType === "classroom").map(courseItem => (
